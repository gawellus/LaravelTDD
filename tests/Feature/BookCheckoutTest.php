...
class BookCheckoutTest extends TestCase
{
    ...
    public function only_signed_user_can_checkout_a_book()
    {
        ...
        //niezalogowany user zostanie przekierowany na logowanie
        $this->post('/checkout/' . $book->id)
            ->assertRedirect('/login');

        //upewniamy się, że nic się nie  zmieniło w bazie
    ...
    public function a_book_can_be_check_in_by_signed_in_user()
    {
        ...
        /**
         * inne podejscie to utworzyc rezerwacje w bazie
         * ale dzieki korzystaniu z endpointow testujemy calosc,
         * dobre dla unit test
         * 
         * Reservation::create{[
